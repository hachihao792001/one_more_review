...
export class FilterResultComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.filterResultService.getSelectedPropery().subscribe(data => this.selectedProperty = data);
    this.selectedNation = JSON.stringify(this.selectedProperty.nation);
    this.selectedType = this.selectedProperty.type;
    this.selectedYear = this.selectedProperty.year;
  }
